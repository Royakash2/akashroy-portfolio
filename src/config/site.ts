...
export const site = {
  ...
  skillCategories: {
    ...
    Frontend: ["React", "Next.js", "Tailwind CSS", "shadcn/ui", "Gatsby", "Figma"],
    Backend: ["Node.js", "Express", "GraphQL", "REST APIs", "WordPress"],
    Databases: ["PostgreSQL", "MongoDB", "Prisma"],
    Tools: ["Git", "Vercel", "VS Code", "Cursor", "Antigravity"],
  },
  skills: [
    "React",
    "Next.js",
